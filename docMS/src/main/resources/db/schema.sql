...
-- 图书表
CREATE TABLE IF NOT EXISTS lp_doc (
...
CREATE TABLE IF NOT EXISTS lp_img (
    ...
    `doc_id` bigint DEFAULT NULL COMMENT '图书ID',
...
-- 图书章节表
CREATE TABLE IF NOT EXISTS `lp_doc_section` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '章节ID',
  `doc_id` bigint NULL DEFAULT NULL COMMENT '书籍id',
...
-- 书籍与主题关联表
CREATE TABLE IF NOT EXISTS lp_doc_topic (
    id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '书籍与主题关联表ID',
    doc_id BIGINT NOT NULL COMMENT '书籍ID',
...
CREATE TABLE IF NOT EXISTS `lp_doc_file` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '关联ID',
  `doc_id` bigint DEFAULT NULL COMMENT '书籍ID',
  ...
  UNIQUE INDEX `idx_doc_file`(`doc_id`, `file_id`, `is_deleted`) USING BTREE COMMENT '避免重复关联'
